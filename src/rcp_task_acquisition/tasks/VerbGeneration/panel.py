...
class VerbGenerationPanel(TrialPanel):
    ...
    def _set_up_photo(self):
        ...
        self.noun_choice = wx.Choice(self, id=wx.ID_ANY, choices=self.verb_lists, size=(310, -1))
        ...
        grid_sizer.Add(
            noun_text, pos=(2, 0), span=(0, 4), flag=wx.ALIGN_CENTER | wx.ALL, border=self.border
        )
        grid_sizer.Add(
            self.noun_choice,
            pos=(3, 0),
