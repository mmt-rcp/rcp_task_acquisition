...
class Window(Window):
    ...
    def __init__(
        ...
        self._patch = GratingStim(self, tex=_highStateTexture, size=(s, s), pos=(x, y), units="pix")
        self._backgroundColor = color
        self._background = GratingStim(
            self, tex=_lowStateTexture, size=(self.width, self.height), units="pix"
        )
